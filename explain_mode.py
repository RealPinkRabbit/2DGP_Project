...
def draw():
    ...
    explain_font.draw(100, 250, '                       space_bar : 스톤 투구', (255, 255, 255))
    explain_font.draw(100, 200, '    (투구 후)       ↑,←,→ : 스위핑 조작', (255, 255, 255))
    explain_font.draw(100, 150, '                       a,d : 움직이는 다른 스톤 조작', (255, 255, 255))
    explain_font.draw(100, 100, '     (항시)           w : 하우스 상황 확인       ESC : 일시정지', (255, 255, 255))
